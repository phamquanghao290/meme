      ...
      <div className="Checkout">
        ...
        <div className="Bill">
          <div>
            ...
            <div>
              <button className="cursor-pointer bg-[#8A33FD] text-white font-bold py-2 px-4 rounded mt-7">
                Continue to Shipping
              </button>
              <Checkbox onChange={onChange} style={{ marginLeft: "30px" }}>
            ...
            {cart.map((item, index) => (
              <div>
                <div className="sp" key={index}>
                  <img src={item.product.image} alt="" className="max-w-[90px] w-full max-h-[100px] h-full" />
                  <div>
